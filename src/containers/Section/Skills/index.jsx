...
const SectionSkills = () => (
  <div className={styles.skills}>
    <div className={`${styles.part} ${styles.left}`}>
      <span>Since middle school I've been "learning by doing". I quickly pick up and learn new topics and in a short amount of time I'm able to contribute on a high level.</span>
    </div>
